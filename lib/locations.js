...
export const LOCATIONS = {
  bellevue: {
    ...
    about: {
      ...
      paras: [
        'Our Bellevue room sits on the second floor of Lincoln Square South, with sweeping views, a long bar, and the same Pacific Northwest seafood Duke has been serving for forty-plus years.',
  ...
  tacoma: {
    ...
    about: {
      ...
      paras: [
        'Duke\u2019s Tacoma sits right on Ruston Way, with the best waterfront view dining in the city. The same sustainable seafood, grass-fed burgers, and award-winning chowder you\u2019ll find at every Duke\u2019s, with Puget Sound out the window.',
  ...
  'lake-union': {
    ...
    heroHeadline: ['The best view on ', 'Lake Union'],
    heroLede: 'Front-row views of Lake Union and the city skyline, minutes from downtown Seattle, on the deck that won \u201cBest in the Sound.\u201d',
    heroPhoto: '/images/slu-interior.jpg',
    about: {
      heading: ['Right in the middle of ', 'Seattle'],
      paras: [
        'The view is the whole point here. Duke\u2019s South Lake Union looks straight out over the water, the marina, and the Seattle skyline beyond it, with a deck that catches the afternoon sun and took home \u201cBest in the Sound.\u201d',
        'You\u2019re right in the middle of Seattle, a few minutes from downtown, Capitol Hill, and Queen Anne, with easy parking and the streetcar at the door. Come for lunch on the water, a sunset dinner on the deck, or happy hour 3\u20136pm and 9pm\u2013close, seven days a week.',
      ],
    },
  ...
  'green-lake': {
    ...
    heroLede: 'A cozy patio for the cooler months, fabulous Green Lake views all summer, and a warm neighborhood dining room year-round.',
    heroPhoto: '/images/greenlake-hero.jpg',
    about: {
      heading: ['Your ', 'Green Lake'],
      paras: [
        'Duke\u2019s Green Lake is a true neighborhood restaurant, warm and family-friendly year-round, with a patio that comes into its own when the lake is at its best in summer.',
  ...
  southcenter: {
    ...
    heroLede: 'A welcome break from a day at Westfield Southcenter, right in the south lot, with wild seafood, a full bar, and a big patio when you need to get off your feet.',
    heroPhoto: '/images/southcenter-hero.jpg',
    about: {
      heading: ['Easy to reach, room to ', 'gather'],
      paras: [
        'Duke\u2019s Southcenter sits in the south lot at Westfield Southcenter, making it an easy addition to any day of shopping. Stop in for lunch or dinner with a big outdoor patio, a full bar, and the same sustainable seafood you\u2019ll find at every Duke\u2019s.',
