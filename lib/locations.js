...
export const LOCATIONS = {
  ...
  'lake-union': {
    ...
    heroLede: 'Some of the best waterfront views in Seattle, central to the city right on Lake Union, with a deck that won \u201cBest in the Sound.\u201d',
    heroPhoto: '/images/slu-interior.jpg',
    about: {
      heading: ['On the water in ', 'South Lake Union'],
      paras: [
        'Duke\u2019s South Lake Union sits right on the water, with sweeping views over Lake Union and the marina. The deck won \u201cBest in the Sound\u201d for a reason: some of the best views in the city, ample sunshine, and a casual, no-fuss atmosphere.',
        'Central to everything in Seattle and easy to reach from downtown, South Lake Union, and the waterfront. Join us indoors or out when the sun is shining, with happy hour 3\u20136pm and 9pm\u2013close, seven days a week.',
      ],
    },
