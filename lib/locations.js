...
export const LOCATIONS = {
  bellevue: {
    ...
    about: {
      heading: ['Family-owned, since ', '1976'],
      paras: [
    ...
    menuPhoto: '/images/loc-bellevue.jpg',
    events: {
      intro: [
      ...
      options: [
        ...
        { opt: 'Option 02 — Mixed', title: 'Seated & standing', desc: 'Seating for ten on the left, two cocktail tables in the middle, appetizer service on the right.', cap: 'Seats 10 · up to 30', photo: '/images/chowder.jpg' },
        { opt: 'Option 03 — Seated dinner', title: 'Sit-down dining', desc: 'The full room set as a single seated dinner or lunch — perfect for plated service.', cap: 'Seats up to 28', photo: '/images/dukes-chowder.jpg' },
        { opt: 'Option 04 — Seated, with gift table', title: 'Celebration setup', desc: 'Seated dining with a gift table next to the window. Common for showers and milestone birthdays.', cap: 'Seats up to 20', photo: '/images/duke-sourcing.jpg' },
        { opt: 'Option 05 — Cocktails & dinner', title: 'Cocktail hour, then seated', desc: 'Open the room for a cocktail hour, then transition to a seated dinner. Optional gift table by the window.', cap: 'Seats up to 16', wide: true, photo: '/images/john-and-duke.jpg' },
      ],
    },
    hours: [
  ...
  tacoma: {
    ...
    heroPhoto: '/images/loc-tacoma.jpg',
    about: {
    ...
    menuPhoto: '/images/loc-tacoma.jpg',
    events: {
      intro: [
      ...
      options: [
        { opt: 'Group dining', title: 'Waterfront deck', desc: 'Outdoor deck seating with views across Commencement Bay to Mount Rainier.', cap: 'Seasonal · weather permitting', photo: '/images/loc-tacoma.jpg' },
        { opt: 'Group dining', title: 'Dining room', desc: 'Indoor group seating for celebrations and business gatherings year-round.', cap: 'Groups welcome', photo: '/images/chowder.jpg' },
      ],
      needsConfirm: true,
    },
    hours: [
  ...
  'lake-union': {
    ...
    events: {
      ...
      options: [
        { opt: 'Private dining', title: 'Party facilities', desc: 'A dedicated space for private events with views over Lake Union and the marina.', cap: 'Groups & celebrations', photo: '/images/loc-slu.jpg' },
        { opt: 'Group dining', title: 'Waterfront deck', desc: 'Award-winning deck seating for warm-weather group gatherings.', cap: 'Seasonal', photo: '/images/chowder.jpg' },
      ],
      needsConfirm: true,
    },
    hours: [
    ...
    addressLines: ['901 Fairview Ave N', 'Seattle, WA 98109'],
    phone: '(206) 382-9963',
    phoneHref: '2063829963',
    metaLines: ['Waterfront deck on Lake Union · \u201cBest in the Sound\u201d', 'Parking available · confirm details on the live site'],
    mapsQuery: '901+Fairview+Ave+N+Seattle+WA+98109',
    needsConfirmAddress: true,
  },
  ...
  'green-lake': {
    ...
    heroPhoto: '/images/loc-greenlake.jpg',
    about: {
    ...
    menuPhoto: '/images/loc-greenlake.jpg',
    events: {
      intro: [
      ...
      options: [
        { opt: 'Group dining', title: 'Dining room & bar', desc: 'Relaxed group seating in a neighborhood room with one of the area\u2019s best bars.', cap: 'Groups welcome', photo: '/images/loc-greenlake.jpg' },
        { opt: 'Group dining', title: 'Patio', desc: 'Outdoor patio seating for warm-weather gatherings.', cap: 'Seasonal', photo: '/images/chowder.jpg' },
      ],
      needsConfirm: true,
    },
    hours: [
  ...
  southcenter: {
    ...
    heroPhoto: '/images/loc-southcenter.jpg',
    about: {
    ...
    menuPhoto: '/images/loc-southcenter.jpg',
    events: {
      intro: [
      ...
      options: [
        { opt: 'Group dining', title: 'Big outdoor patio', desc: 'A large patio for warm-weather group gatherings and celebrations.', cap: 'Seasonal', photo: '/images/loc-southcenter.jpg' },
        { opt: 'Group dining', title: 'Dining room & bar', desc: 'Indoor seating and a full bar for year-round group dining.', cap: 'Groups welcome', photo: '/images/chowder.jpg' },
      ],
      needsConfirm: true,
    },
    hours: [
    ...
    addressLines: ['633 Southcenter Mall', 'Tukwila, WA 98188'],
    phone: '(206) 257-4628',
    phoneHref: '2062574628',
    metaLines: ['South lot at Westfield Southcenter · ample parking', 'Big outdoor patio · full bar'],
    mapsQuery: 'Dukes+Seafood+Southcenter+Tukwila+WA',
    needsConfirmAddress: true,
  },
  ...
  'kent-station': {
    ...
    events: {
      ...
      options: [
        { opt: 'Group dining', title: 'Dining room', desc: 'Family-friendly group seating with one of Kent\u2019s best happy hours at the bar.', cap: 'Groups & families', photo: '/images/loc-kent.jpg' },
        { opt: 'Group dining', title: 'Patio', desc: 'Outdoor patio seating for warm-weather gatherings.', cap: 'Seasonal', photo: '/images/chowder.jpg' },
      ],
      needsConfirm: true,
    },
    ...
    addressLines: ['348 Ramsay Way, Suite 101', 'Kent, WA 98032'],
    phone: '(253) 854-3853',
    phoneHref: '2538543853',
    metaLines: ['Kent Station · family-friendly', 'Takeout & DoorDash across the Kent Valley'],
    mapsQuery: 'Dukes+Seafood+Kent+Station+Kent+WA',
    needsConfirmAddress: true,
  },
};
