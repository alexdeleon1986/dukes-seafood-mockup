    ...
    <div className="page-simple">
      ...
      <section className="sec alt">
        <div className="shell-narrow">
          <div className="sec-head"><h2 className="h-display">Already have <em>one</em>?</h2></div>
          ...
          <a href={BALANCE_LINK} className="btn btn-ghost btn-lg" target="_blank" rel="noopener noreferrer" style={{ marginTop: 8 }}>Check your balance <span className="arrow">→</span></a>
        </div>
      </section>
    </div>
  );
